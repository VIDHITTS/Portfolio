                    ...
                    <div className="md:col-span-7">
                        <div className="text-lg text-muted-foreground max-w-[450px]">
                            ...
                            <p className="mt-3 slide-up-and-fade">
                                Former vice-captain with a proven record of
                                leading impactful projects and author of{' '}
                                <span className="font-medium text-foreground">
                                    Bully or Victim
                                </span>
                                . My approach focuses on creating scalable,
                                high-performing solutions that prioritize
                                performance, user experience, and deliver
                                tangible results.
                            </p>
                        </div>
                    </div>
