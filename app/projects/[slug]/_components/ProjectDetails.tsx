            ...
            <div className="container" ref={containerRef}>
                <div className="sticky top-20 z-[10] mb-16">
                    <TransitionLink
                        back
                        href="/"
                        className="inline-flex gap-2 items-center group h-12 bg-black/50 backdrop-blur-sm px-4 py-2 rounded-full border border-white/10 hover:border-primary/50 transition-all"
                    >
                ...
                >
                    <div className="relative w-full">
                        <div className="flex items-start gap-6 mx-auto mb-10 max-w-[635px]">
                            ...
                            <div className="fade-in-later opacity-0 flex flex-col gap-3">
                                {project.liveUrl && (
                                    <a
                ...
                >
                    {project.images.map((image) => (
                        <div
                            key={image}
                            className="group relative w-full overflow-hidden bg-background-light rounded-lg"
                        >
                            <img
                                src={image}
                                alt={project.title}
                            ...
                            <a
                                href={image}
                                target="_blank"
                                className="absolute top-4 right-4 bg-background/70 text-foreground size-12 inline-flex justify-center items-center transition-all opacity-0 hover:bg-primary hover:text-primary-foreground group-hover:opacity-100 rounded-lg"
                            >
                                <ExternalLink />
                            </a>
                        </div>
